...
## Introduction
A simple but powerful Validation Engine.

> To note that it uses the new **Database API** for verification of data presence in the Database. If you use this Validation, you MUST use the new **Database API** in the entire application, and NOT the **Helpers\Database**.
...
```
> *Note:* The `:attribute` place-holder will be replaced by the actual name of the field under validation. You may also utilise other place-holders in validation messages.
